...
const RetroVersion = () => {
  ...
  const handleExitRetro = () => {
    ...
    return (
      <>
        <Meta 
          title="Retro | Mehran Shahani"
          description="Step into the retro classic view of Mehran Shahani's portfolio — a single-page newspaper-style presentation of all major sections."
          url="https://mehranshahani.com/retro-version"
          keywords="retro portfolio, Mehran Shahani, newspaper layout, terminal UI, full-page portfolio"
